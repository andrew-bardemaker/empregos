...
if (!empty($_POST['id_usuario']) && isset($_POST['id_usuario']) && is_numeric($_POST['id_usuario']) &&
	!empty($_POST["assunto"]) && isset($_POST['assunto']) && 
	!empty($_POST["categoria"]) && $_POST["categoria"] != "" && is_numeric($_POST["categoria"]) &&
	!empty($_POST["mensagem"]) && isset($_POST['mensagem'])) {
 ...
 */
	...
	$mail2->Host = 'smtp.geladaemcasaapp.com.br';          // Specify main and backup SMTP servers
	$mail2->SMTPAuth = true;                               // Enable SMTP authentication
	$mail2->Username = 'noreply@geladaemcasaapp.com.br';   // SMTP username
	...
	$mail->Host = 'smtp.geladaemcasaapp.com.br';          // Specify main and backup SMTP servers
	$mail->SMTPAuth = true;                               // Enable SMTP authentication
	$mail->Username = 'noreply@geladaemcasaapp.com.br';   // SMTP username
	$mail->Password = 'bejobs2020';                          // SMTP password
	$mail->SMTPSecure = false; 							  // Define se é utilizado SSL/TLS - Mantenha o valor "false"
	$mail->SMTPAutoTLS = false; 						  // Define se, por padrão, será utilizado TLS - Mantenha o valor "false"
	$mail->Port = 587;                                    // TCP port to connect to

	$mail->setFrom('noreply@geladaemcasaapp.com.br', 'Llevo App');
