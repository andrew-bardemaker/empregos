...
if($obj){
    ...
    $id_vaga=$obj->id_vaga;
    $sql_select= "SELECT id_empresa FROM bejobs_vagas WHERE id=$id_vaga";
    ...
    $sql_insert="INSERT INTO `bejobs_candidaturas`(`id_usuario`, `id_vaga`, `id_empresa`) VALUES ('$id_user','$id_vaga','$id_empresa')";
