...
if ($obj) {
    ...
    $id_vaga = $obj->id_vaga;
    $sql_delete = "DELETE FROM  `bejobs_candidaturas` WHERE id_vaga='$id_vaga' and id_usuario='$id_user'";
    $dba->query($sql_delete);
    $array_retorno = array("success" => true, "message" => "Candidatura retirada com suceso");
} else {
