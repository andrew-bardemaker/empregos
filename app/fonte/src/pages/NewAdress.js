...
class NewAdress extends React.Component {
    constructor(props) {
        super(props);
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12} lg={12} >
                                    <Typography variant="subtitle1" align="center" color="secondary" paragraph>
                                        Olá, atualmente estamos entregando nos bairros de Porto Alegre listados abaixo: <br />
                                        <Bairros />
                                        Vai te preparando, em breve estaremos atendendo em diversos outros bairros de nossa querida cidade.<br />
                                    </Typography>
                                </Grid>
                            </Grid>
                        </Container>
...
export default withStyles(useStyles)(NewAdress);